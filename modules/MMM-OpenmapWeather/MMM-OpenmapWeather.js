...
Module.register("MMM-OpenmapWeather", {
	...
	// Define required scripts.
	getStyles: function () {
		return ["weather-icons.css", "MMM-OpenmapWeather.css"];
	},
	...
	updateWeather: function () {
		if (this.config.appid === "") {
			Log.error("MMM-OpenmapWeather: APPID not set!");
			return;
		}
	...
	processWeather: function (data) {
		...
		this.weatherTypeTxt = "<img src='./modules/MMM-OpenmapWeather/img/" + this.config.iconImageTable[data.weather[0].icon] + "' style='vertical-align:middle' class='currentWeatherIcon'>";
